...
public class BoxWeight_Child extends Box_Base {
    ...
    public BoxWeight_Child(double l,double w,double h,double weight){
        ...
        //The super keyword calls the parent class's contructors. Lets assume a situation lets say we have the classes a b and c in multi inheritance. Super on c calls b, super on b calls a, but super on a calls class objects which is the superclass for all the classes.
